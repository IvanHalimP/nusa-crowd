...
class SuIdTTS(datasets.GeneratorBasedBuilder):
    ...
    def _generate_examples(self, male_filepath: Path, female_filepath: Path):
        ...
        if self.config.schema == "source" or self.config.schema == "nusantara_sptext":
            tsv_file = os.path.join(male_filepath, "su_id_male", "line_index.tsv")
            with open(tsv_file, "r") as file:
                ...
                for line in tsv_data:
                    ...
                    wav_path = os.path.join(male_filepath, "su_id_male", "wavs", "{}.wav".format(audio_id))
            ...
            tsv_file = os.path.join(female_filepath, "su_id_female", "line_index.tsv")
            with open(tsv_file, "r") as file:
                tsv_data = csv.reader(file, delimiter="\t")
